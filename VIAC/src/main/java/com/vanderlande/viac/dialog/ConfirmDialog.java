 ...
 * @author desczu
 * 
 *         This class displays a confirm-dialog. Instantiate the dialog once and then just use showMessage() to display
 *         the dialog.
 */
public class ConfirmDialog extends ModalWindow
{
    ...
    {
        this.setContent(new ConfirmDialogContent(this.getContentId(), message, confirmCommand, declineCommand));
        this.show(target);
    }
}
