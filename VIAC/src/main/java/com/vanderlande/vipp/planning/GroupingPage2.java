...
/**
 * The Class GroupingPage2.
 * 
 * @author dermic
 * 
 */
public class GroupingPage2 extends VIPPBasePage implements Serializable
{
    ...
    /**
     * Instantiates a new grouping page.
     */
    public GroupingPage2()
    {
    ...
    public GroupingPage2(int amountGroups, int option, int extragroupNumber)
    {
    	...
    	if(option == 0)
    	{
	    	groupList = createGroupsMixed(amountGroups, extragroupNumber);
    	}
    	if(option == 1)
    	{
    		groupList = createGroupsYear();
    	}
    	init();
    }
    
    public GroupingPage2(List<VIPPGroup> groupListArea, int extragroupNumber) { 
    	DatabaseProvider.getInstance().create(cycle);
    	this.groupListArea = groupListArea;
    	groupList =  createGroupsArea(groupListArea, extragroupNumber);
		init();
	}
    ...
    private List<VIPPGroup> createGroupsMixed(int groupAmount, int extragroupNumber) 
    {
    ...
    private List<VIPPGroup> createGroupsYear()
    {
    ...
    private List<VIPPGroup> createGroupsArea(List<VIPPGroup> grouplistArea, int extragroupNumber)
    {
