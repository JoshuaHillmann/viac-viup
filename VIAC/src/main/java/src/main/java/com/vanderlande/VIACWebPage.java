package src.main.java.com.vanderlande;
...
/**
 * The Class VIACWebPage. Extend this class if you want to create a BasePage for
 * a module
 */
public abstract class VIACWebPage extends WebPage {
	...
	/**
	 * Instantiates a new VIAC web page. If the user does not have a valid
	 * session, the page will not be initialized
	 */
	public VIACWebPage() {
		if (!isInvalidSession()) {
			initialize();
	...
	/**
	 * Checks if the user is logged in and not banned and if he is, he will be
